...
Answer: SELECT continent, COUNT(name) FROM world WHERE population > 200000000 GROUP BY continent
...
Answer: SELECT continent, SUM(population) FROM world GROUP BY continent HAVING SUM(population)>50000000
