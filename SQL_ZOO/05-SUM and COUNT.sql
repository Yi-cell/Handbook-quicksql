...
Answer: SELECT SUM(population) FROM world WHERE name IN ('Estonia','Latvia','Lithuania')
...
Answer: SELECT continent, COUNT(name) FROM world WHERE population >10000000 GROUP BY continent

--8.List the continents that have a total population of at least 100 million

Answer: SELECT continent FROM world GROUP BY continent HAVING SUM(population) > 100000000
